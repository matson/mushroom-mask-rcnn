...
'''
Mask R-CNN — extends Faster R-CNN with a mask head.
Categories:
...
# -------- AUGMENTATIONS --------
# No bbox_params needed — bboxes are derived from augmented masks
...
class MushroomCOCODataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for ann in anns:
            ...
            mask = self.coco.annToMask(ann)  # H x W binary mask
            masks.append(mask)
        ...
        masks_tensor = torch.as_tensor(np.stack(valid_masks), dtype=torch.uint8)  # N x H x W
    ...
    for epoch in range(start_epoch, start_epoch + 20):
        ...
        if avg_val_loss < best_val_loss:
            ...
            save_checkpoint(
                ...
                filename="best_maskrcnn_mushroom_FULL.pth"
            )
